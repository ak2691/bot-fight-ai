...
Bot Fight AI is a backend project for creating an AI player for Bot Fight Online. The goal is for the AI to receive information about a match, generate a strategy, test possible programs, and choose one to play.
